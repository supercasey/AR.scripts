...
#' Computation of data necessary to compute the long term mean annual loads for the NAWQA Annual Reporting Website
#'
#' Computes a value to be plotted as a line on bar charts within the detailed site reports
#'
#' @param aload is a data frame with all annual loads from all NAWQA National Fixed Site Network locations.  This data frame is requires 5 columns
...
#' @param const is a character representing  the parameter to be computed, options (as of 2014) include TN, TP, NO3_NO2, anD SSC
