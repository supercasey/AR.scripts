...
if(length(aload[aload$SITE_QW_ID=="03374100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
whi<-	aload[aload$SITE_QW_ID=="03374100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="03378500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
wab<-aload[aload$SITE_QW_ID=="03378500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="03609750"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	ten<-aload[aload$SITE_QW_ID=="03609750"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="03086000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	ohi.1<-aload[aload$SITE_QW_ID=="03086000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="03303280"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
ohi.2<-aload[aload$SITE_QW_ID=="03303280"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="03612500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
ohi.3<-aload[aload$SITE_QW_ID=="03612500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="05586100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
ill<-aload[aload$SITE_QW_ID=="05586100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="05331580"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
mis.1<-aload[aload$SITE_QW_ID=="05331580"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="05420500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mis.2<-aload[aload$SITE_QW_ID=="05420500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="05465500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
iow<-aload[aload$SITE_QW_ID=="05465500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="05490500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	des<-aload[aload$SITE_QW_ID=="05490500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="05587455"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mis.3<-aload[aload$SITE_QW_ID=="05587455"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06329500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	yel<-aload[aload$SITE_QW_ID=="06329500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06610000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mo.1<-aload[aload$SITE_QW_ID=="06610000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06800500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	elk<-aload[aload$SITE_QW_ID=="06800500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06805500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	pla<-aload[aload$SITE_QW_ID=="06805500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06892350"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	kan<-aload[aload$SITE_QW_ID=="06892350"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06902000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	grand<-aload[aload$SITE_QW_ID=="06902000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06926510"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	osag<-aload[aload$SITE_QW_ID=="06926510"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="06934500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mo.2<-aload[aload$SITE_QW_ID=="06934500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07022000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mis.4<-aload[aload$SITE_QW_ID=="07022000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07144100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
lark<-aload[aload$SITE_QW_ID=="07144100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07241550"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	nca<-aload[aload$SITE_QW_ID=="07241550"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07263620"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	ark<-aload[aload$SITE_QW_ID=="07263620"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="322023090544500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mis.5<-aload[aload$SITE_QW_ID=="322023090544500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07288955"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	yaz<-aload[aload$SITE_QW_ID=="07288955"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07355500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	red<-aload[aload$SITE_QW_ID=="07355500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07374000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mis.7<-aload[aload$SITE_QW_ID=="07374000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mis.8<-aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	mis.9<-aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(c(aload[aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"],aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="STFR"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]))==2){
missriv@data[missriv@data$Downstream=="07381495","load"]<-aload[aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]-aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="STFR"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07381495"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
atc.1<-aload[aload$SITE_QW_ID=="07381495"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07381590"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	wax<-aload[aload$SITE_QW_ID=="07381590"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
...
if(length(aload[aload$SITE_QW_ID=="07381600"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"])==1){
	atc2<-aload[aload$SITE_QW_ID=="07381600"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY==wycur,"TONS"]
