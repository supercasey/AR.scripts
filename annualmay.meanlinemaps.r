...
#POPULATE LOADS FOR THE WHITE RIVER BASED ON LINEAR INTERPOLATION, IF NO DATA, SET LOADS TO .011
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="03374100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			whi<-mean(aload[aload$SITE_QW_ID=="03374100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="03378500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			wab<-mean(aload[aload$SITE_QW_ID=="03378500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
...
missriv@data[missriv@data$Downstream=="03378500",]
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="03609750"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			ten<-mean(aload[aload$SITE_QW_ID=="03609750"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="03303280"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			ohi.1<-mean(aload[aload$SITE_QW_ID=="03303280"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="03612500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			ohi.2<-mean(aload[aload$SITE_QW_ID=="03612500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="05586100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			ill<-mean(aload[aload$SITE_QW_ID=="05586100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="05331580"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.1<-mean(aload[aload$SITE_QW_ID=="05331580"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="05420500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.2<-mean(aload[aload$SITE_QW_ID=="05420500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="05465500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			iow<-mean(aload[aload$SITE_QW_ID=="05465500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="05490500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			des<-mean(aload[aload$SITE_QW_ID=="05490500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="05587455"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.3<-mean(aload[aload$SITE_QW_ID=="05587455"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="06329500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			yel<-mean(aload[aload$SITE_QW_ID=="06329500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="06610000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mo.1<-mean(aload[aload$SITE_QW_ID=="06610000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="06800500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			elk<-mean(aload[aload$SITE_QW_ID=="06800500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="06805500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			pla<-mean(aload[aload$SITE_QW_ID=="06805500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="06892350"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			kan<-mean(aload[aload$SITE_QW_ID=="06892350"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
...
if(!is.nan(mean(aload[aload$SITE_QW_ID=="06902000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
	grand<-mean(aload[aload$SITE_QW_ID=="06902000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
...
if(!is.nan(mean(aload[aload$SITE_QW_ID=="06934500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
	mo.2<-mean(aload[aload$SITE_QW_ID=="06934500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
...
if(!is.nan(mean(aload[aload$SITE_QW_ID=="07144100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
	lark<-mean(aload[aload$SITE_QW_ID=="07144100"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
	missriv@data[missriv@data$Downstream=="07144100","load"]<-seq(.1,lark,length.out=nrow(missriv@data[missriv@data$Downstream=="07144100",]))
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07022000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.4<-mean(aload[aload$SITE_QW_ID=="07022000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07241550"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			nca<-mean(aload[aload$SITE_QW_ID=="07241550"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07263620"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			ark<-mean(aload[aload$SITE_QW_ID=="07263620"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="322023090544500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.5<-mean(aload[aload$SITE_QW_ID=="322023090544500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		}else{mis.5.1<-mean(aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])-((mean(aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])-mis.4-ohi.2-ark)*.2)
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07288955"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			yaz<-mean(aload[aload$SITE_QW_ID=="07288955"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07355500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			red<-mean(aload[aload$SITE_QW_ID=="07355500"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.5.1<-mean(aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07374000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.7<-mean(aload[aload$SITE_QW_ID=="07374000"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.8<-mean(aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			mis.9<-mean(aload[aload$SITE_QW_ID=="07374525"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(length(!is.nan(c(mean(aload[aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]),mean(aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="STFR"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))))==2){
			missriv@data[missriv@data$Downstream=="07381495","load"]<-mean(aload[aload$SITE_ABB=="MISS"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])-mean(aload[aload$SITE_QW_ID=="07373420"&aload$SITE_ABB=="STFR"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07381495"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			atc.1<-mean(aload[aload$SITE_QW_ID=="07381495"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07381590"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			wax<-mean(aload[aload$SITE_QW_ID=="07381590"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
		...
		if(!is.nan(mean(aload[aload$SITE_QW_ID=="07381600"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"]))){
			atc2<-mean(aload[aload$SITE_QW_ID=="07381600"&aload$CONSTIT==const&aload$MODTYPE!="COMP"&aload$WY%in%wycur,"TONS"])
