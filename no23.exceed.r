...
return(100*(nrow(dconc[dconc$CONSTIT=="NO3_NO2"&dconc$SITE_QW_ID==staid&dconc$WY==wycur&dconc$CONCENTRATION>10,])/nrow(dconc[dconc$CONSTIT=="NO3_NO2"&dconc$SITE_QW_ID==staid&dconc$WY==wycur,])))
}
